    ...
    <div  class="items-center lg:flex">
        <div class="w-full lg:w-1/2">
            <div  class="lg:max-w-lg">
                ...
                <p class="mt-3 text-gray-600 dark:text-gray-400">Navigate your way to safety with confidence and
                    clarity! Discover the ultimate destination for selecting top-quality road signs that prioritize your
                    well-being. Choose us for the best-in-class safety solutions on every journey.</p>
