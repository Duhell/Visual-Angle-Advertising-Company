            ...
            <div class="w-full ">
                <div class="flex flex-col items-center max-w-lg mx-auto text-center">
                    ...
                    <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                        <button onclick="window.location.href='/contact'" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg dark:text-gray-200 gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:border-gray-700">
                ...
                <div class="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="p-6 rounded-lg bg-blue-50 dark:bg-gray-800">
                        ...
                        <a wire:navigate href="/contact" class="inline-flex items-center mt-4 text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
