					...
					<section class="menu-section px-4">
						...
						<ul class="menu-items">
							...
							<li>
								...
								<label class="menu-item {{ request()->routeIs('admin_CreateReceipt') || request()->routeIs('admin_ManageDeliveries') ? "bg-slate-700 text-slate-100 hover:bg-slate-800":"" }} justify-between" for="deliveryMenu">
									<div class="flex gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
