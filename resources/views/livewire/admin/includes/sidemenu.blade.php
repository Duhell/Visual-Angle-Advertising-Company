<div class="flex flex-row sm:gap-6">
            ...
            <section class="sidebar-content">
				<nav class="menu rounded-md">
					<section class="menu-section px-4">
						...
						<ul class="menu-items">
                            {{-- @persist('menu') --}}
							<li class="menu-item {{ request()->routeIs('admin_Dashboard') ? "bg-slate-700 text-slate-100 hover:bg-slate-800":"" }}">
							...
							<li>
								...
								<label class="menu-item {{ request()->routeIs('admin_CreateReceipt') ? "bg-slate-700 text-slate-100 hover:bg-slate-800":"" }} justify-between" for="deliveryMenu">
									<div class="flex gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
								...
								<div class="menu-item-collapse">
									<div class="min-h-0">
										...
										<label class="menu-item ml-6">Manage Deliveries</label>
									</div>
								</div>
							</li>

                            <li>
								<input type="checkbox" id="voucherMenu" class="menu-toggle" />
								<label class="menu-item justify-between" for="voucherMenu">
									<div class="flex gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
								...
								<div class="menu-item-collapse">
									<div class="min-h-0">
										<label class="menu-item menu-item-disabled ml-6">Vouchers Menu</label>
										<label class="menu-item ml-6">Create Voucher</label>
										<label class="menu-item ml-6">Manage Vouchers</label>
									</div>
								</div>
							</li>
                            {{-- @endpersist() --}}
	...
	<div class="flex w-full flex-col p-4">
		...
		<div class="my-4  text-[#333] w-full">
            {{ $slot }}
		</div>
	</div>
</div>
